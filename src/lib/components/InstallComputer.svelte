...
{#if channelId && decision.state !== "served" && !dismissed}
	<section class="install">
		...
		{#if decision.state === "choose"}
			...
			<p class="ic-note">Any computer signed in with your key can serve this space. You can change it later in space settings. Create an agent under <strong>Agent</strong> and set its Computer property to it.</p>
		{:else}
			<ol class="ic-steps">
				<li>
