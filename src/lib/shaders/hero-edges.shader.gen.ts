...
const HeroEdges: CompiledShader<{ aQuad: 'vec2' }, { iA: 'float'; iB: 'float'; iTint: 'vec3'; iBirth: 'float'; iDeath: 'float' }, { uViewProj: 'mat4'; uTime: 'float'; uMouse: 'vec2'; uWidth: 'float'; uNow: 'float'; uNodes: 'storage' }> = {
