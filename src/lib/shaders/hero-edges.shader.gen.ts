...
const HeroEdges: CompiledShader<{ aQuad: 'vec2' }, { iStart: 'vec3'; iEnd: 'vec3'; iTint: 'vec3' }, { uViewProj: 'mat4'; uTime: 'float'; uMouse: 'vec2'; uWidth: 'float' }> = {
...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  ...
  return vec4f(bm_in.vTint, taper * 0.8);
}
`,
  ...
  layout: {"attributes":[{"name":"aQuad","type":"vec2","location":0,"size":2,"divisor":0},{"name":"iStart","type":"vec3","location":1,"size":3,"divisor":1},{"name":"iEnd","type":"vec3","location":2,"size":3,"divisor":1},{"name":"iTint","type":"vec3","location":3,"size":3,"divisor":1}],"uniforms":[{"name":"uViewProj","type":"mat4","kind":"m4fv","size":16,"offset":0},{"name":"uTime","type":"float","kind":"1f","size":1,"offset":64},{"name":"uMouse","type":"vec2","kind":"2fv","size":2,"offset":72},{"name":"uWidth","type":"float","kind":"1f","size":1,"offset":80}],"uniformBlockSize":96},
