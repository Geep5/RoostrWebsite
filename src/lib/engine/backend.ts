...
class WebBackend {
	...
	private static readonly HIDDEN_LIST_TYPES = new Set(["program", "typescript", "json", "proto", "relation", "channel", "skill", "peer", "pinned_fact", "milestone", "descriptor", "install", "vanish_log"]);
